...
in batches, referred to in the **Payroll** app as :doc:`*Pay Runs* <../pay_runs>`.
...
<payroll/australia/journal>`, and :ref:`registering payments <payroll/australia/register>`.

.. _payroll/australia/journal:
...
.. _payroll/australia/register:

Register Payments
-----------------

After the :ref:`journal entries <payroll/australia/journal>` are validated, Odoo can generate
payments.
