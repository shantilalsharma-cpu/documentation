...
To send the mailing, click :guilabel:`Send`. On the :guilabel:`Ready to unleash emails?` pop-up
window, click :guilabel:`Send to all` to send the cards to the specified recipients.
