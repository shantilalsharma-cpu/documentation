...
- create and use :ref:`templates <sign/request-signatures/templates>` to send frequently used
  documents for signing from the Sign app or from an Odoo record
- create :ref:`document envelopes <sign/request-signatures/create-envelope>` to send multiple
