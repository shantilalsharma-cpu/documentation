...
for. Only after a rental order is confirmed can rental products be picked up.
...
.. note::
   ...
   Rental Prices` next to the :guilabel:`Pricelist` field.
...
.. image:: create_rental_order/request-signature.png
...
The page defaults to a *Gantt* view of all the open shifts and shifts for the associated role that
are available for the rental period of the rental order. :ref:`Customize the shifts
<planning/shifts>` as needed.
...
Managing a project created from the rental order
================================================
...
tasks automatically created when confirming the rental order. :doc:`Customize the project's tasks
<../../../services/project/tasks/task_creation>` as needed.
...
Entering the time for the rental service task
---------------------------------------------
...
rental order and click the :icon:`fa-clock-o` :guilabel:`Recorded` icon smart button at the top of
the rental order. The total hours worked appear in the :guilabel:`Recorded Time` field.

Create an invoice
=================

Navigate to the desired invoice in the **Rental** app. On the :guilabel:`Rental Orders` dashboard,
in the :guilabel:`INVOICE STATUS` section, click :guilabel:`To Invoice` to view all rental orders
that need to be sent.

.. image:: create_rental_order/invoice-status-section.png
...
.. image:: create_rental_order/create-invoices.png
   :alt: Sample of Create invoices window in the Rental app.

Finalize the amount of time for physical service products
---------------------------------------------------------
...
.. image:: create_rental_order/draft-invoice-for-hotel-room.png
   :alt: Draft invoice for a hotel room for one night stay.
